# Evualation quality of prediction on logistic regression using Indels & SNPs 
# without excluding rare mutations features datasets
...
data = pd.read_csv(f"{bess_dir}/{drug}.gt.1", sep=' ', 
        index_col=None, header=None)
pheno = pd.read_csv(f"{bess_dir}/{drug}.phen", sep=' ', index_col=None, header=None)
pos_info = pd.read_csv(f"{bess_dir}/{drug}.gt.pos.1", sep='\t', 
