...
if __name__ == '__main__':
    ...
    estimate_pvalue()
    print_full_table()
    merge_tables('./tree_features_supplementary.table', './tree_features_grouped_supplementary.table')
    merge_loc_and_lineages('./id_with_locs_and_lineages.table')
    merge_tree_breaker_features('./tree_breaker.table')